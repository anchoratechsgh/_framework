...
require_once dirname(__FILE__).DS.'MetadataLoaderInterface.php';
require_once dirname(__FILE__).DS.'DefaultMetadataLoader.php';
require_once dirname(__FILE__).DS.'MetadataSourceInterface.php';
require_once dirname(__FILE__).DS.'PhoneNumberDesc.php';
require_once dirname(__FILE__).DS.'NumberFormat.php';
require_once dirname(__FILE__).DS.'PhoneMetadata.php';
require_once dirname(__FILE__).DS.'PhoneNumberType.php';
require_once dirname(__FILE__).DS.'ValidationResult.php';
require_once dirname(__FILE__).DS.'PhoneNumberFormat.php';
require_once dirname(__FILE__).DS.'MultiFileMetadataSourceImpl.php';
require_once dirname(__FILE__).DS.'CountryCodeToRegionCodeMap.php';
require_once dirname(__FILE__).DS.'MatcherAPIInterface.php';
require_once dirname(__FILE__).DS.'RegexBasedMatcher.php';
require_once dirname(__FILE__).DS.'NumberParseException.php';
require_once dirname(__FILE__).DS.'PhoneNumber.php';
require_once dirname(__FILE__).DS.'CountryCodeSource.php';
require_once dirname(__FILE__).DS.'Matcher.php';
