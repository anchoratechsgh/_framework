...
Class crontab_manager {
    ...
    public function remove_cronjob($cron_jobs=NULL) {
			...
			// if (empty($cron_array)) $this->error_message("Nothing to remove!  The cronTab is already empty.");$original_count = count($cron_array);
	    ...
	    // }
			...
			$this->remove_file();
			return $this->exec("crontab -l | grep -v ".$cron_jobs." | crontab -");
		}
