...
class Engine
{
    ...
    public static function sanitize2($str)
    {
        return html_entity_decode(mb_convert_encoding($str, 'UTF-8', 'UTF-8'));
    } #end
    ...
    public static function validateNumber($number, $host = 'GH')
    {
        ...
        $carriers['GH'] = ['023', '024', '054', '055', '027', '057', '028', '028', '020', '050', '026', '056', '059'];
